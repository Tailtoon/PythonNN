...
class ResImageDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        inpainted_images = io.imread(os.path.join(self.dir_name, "inpainted", self.inpainted[index]))

        sample = {"raw": raw_image, "inpainted": inpainted_images}
...
def main():
    # dataset = ResImageDataset("Images")
    ...
    #     plt.tight_layout()
    #     ax.set_title('Inpainted №{}'.format(i))
    #     ax.axis('off')
